...
@section( 'content' )
    ...
    {{ Form::open() }}
        ...
        {{ Form::text( 'username', '', array( 'placeholder' => 'john.smith', 'class' => 'textfield textfield-narrow' ) ) }}
        ...
        {{ Form::text( 'email', '', array( 'placeholder' => 'john.smith@email.com', 'class' => 'textfield textfield-narrow' ) ) }}
